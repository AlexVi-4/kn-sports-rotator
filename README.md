...
2. Create authorization (`USER_PASSCODE` to view the rotation, `ADMIN_PASSCODE` to manage rotations). Passcodes must be passed as environment variables and NOT stored in git repo.
